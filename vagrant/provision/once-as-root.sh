...
apt-get install -y php8.0-curl php8.0-cli php8.0-intl php8.0-mysqlnd php8.0-gd php8.0-fpm php8.0-mbstring php8.0-xml unzip nginx mysql-server-5.7 php.xdebug
